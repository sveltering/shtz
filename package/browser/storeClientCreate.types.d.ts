...
type AdditionalMethodsFinal<Methods extends {
...
type $ManyExtension<Input, Data, Opts extends $ManyOpts<Input, Data>> = (Opts["remove"] extends true ? {
    remove: () => Promise<void>;
} : {}) & (Opts["abortOnRemove"] extends true ? {
    remove: () => Promise<void>;
...
type $ManyResponse<Input, EntryLoading extends {}, EntrySuccess extends {}, Data, Opts extends $ManyOpts<Input, Data>> = StaleReponse<$ManyExtension<Input, Data, Opts> & {
    ...
    entry: EntryLoading;
}> | (Opts["abort"] extends true ? AbortedResponse<$ManyExtension<Input, Data, Opts> & {
    entry: EntryLoading;
}> : ErrorResponse<$ManyExtension<Input, Data, Opts> & {
    entry: EntryLoading;
}>) | (Opts["abort"] extends true ? LoadingResponse<$ManyExtension<Input, Data, Opts> & {
    abort: () => void;
    entry: EntryLoading;
...
type $MultipleResponseInner<Input, EntryLoading extends {}, EntrySuccess extends {}, Data, Methods, Opts extends $MultipleOpts<Input, Data>> = SuccessResponse<Data, Methods & $MultipleExtension<Input, Data, Opts> & {
    entry: EntrySuccess;
}> | ErrorResponse<Methods & $MultipleExtension<Input, Data, Opts> & {
    entry: EntryLoading;
}> | (Opts["abort"] extends true ? AbortedResponse<Methods & $MultipleExtension<Input, Data, Opts> & {
    entry: EntryLoading;
}> : ErrorResponse<Methods & $MultipleExtension<Input, Data, Opts> & {
    entry: EntryLoading;
}>) | (Opts["abort"] extends true ? LoadingResponse<Methods & $MultipleExtension<Input, Data, Opts> & {
    abort: () => void;
    entry: EntryLoading;
}> : LoadingResponse<Methods & $MultipleExtension<Input, Data, Opts> & {
    entry: EntryLoading;
}>);
