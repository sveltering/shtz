...
type BeforeResolve = (arg: { dotPath: string; event: RequestEvent; pipe: KeyValueObject }) => Promise<void | HTTPResponse>;
...
type CallerType<T extends TRPC<any, any, any>, Caller extends RoutesType> = T extends TRPC<any, any, infer X>
    ? X extends "always"
