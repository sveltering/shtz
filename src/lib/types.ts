...
export type ProcedureReturnType<T extends AsyncFunctionType> =
	AsyncReturnType<T>;
...
type LocalsAllowed<L> = L extends LocalsAllowedOptions
	? L
	: LocalsAllowedOptions;

export type TRPCOpts<
	Ctx extends KeyValueObject,
	LocalsKey,
	LocalsType
> = Prettify<
	{
...
type DefaultOrSetKey<T extends TRPC<any, any, any>> =
	T["options"]["localsKey"] extends undefined
		? "TRPC"
		: T["options"]["localsKey"];

type CallerKey<T extends TRPC<any, any, any>> =
	T["options"]["localsKey"] extends undefined
...
export type TRPCLocalCreate<
	tRPC extends TRPC<any, any, any>,
