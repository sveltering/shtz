...
type $EntryOpts<Data, EntryFinal extends {}> = {
	prefill?: [any, Data][] | (() => ToPromiseUnion<[any, Data][]>);
	loading?: boolean;
	remove?: boolean;
	abort?: boolean;
	abortOnRemove?: boolean;
...
type $EntryResponseInner<
	...
	Opts extends $EntryOpts<Data, EntryFinal>
> =
	| SuccessResponse<Data, $EntryExtension<EntryFinal, Data, Opts> & { entry: EntryFinal }>
	| ErrorResponse<$EntryExtension<EntryFinal, Data, Opts> & { entry: EntryLoading }>
	| (Opts['abort'] extends true
			? AbortedResponse<
					Omit<$EntryExtension<EntryFinal, Data, Opts>, 'aborted'> & {
						entry: EntryLoading;
					}
			  >
			: ErrorResponse<
					$EntryExtension<EntryFinal, Data, Opts> & {
						entry: EntryLoading;
					}
			  >)
	| (Opts['abort'] extends true
...
type $EntryInner<
	...
	test1
> = {
	responses: Prettify<$EntryResponseInner<EntryLoading, EntryFinal, Data, Opts>>[];
	call: (...args: Args) => void;
	final: test1;
} & (Opts['loading'] extends true ? { loading: false } : {});
...
type $EntryStore<
	...
	Opts extends $EntryOpts<Data, EntryFinal>,
	test1
> = Writable<$EntryInner<Args, EntryLoading, EntryFinal, Data, Opts, test1>>;
...
type $EntryFn<Args extends any[], Data> = <
	...
	EntrySuccessFinal extends Combine<FirstNotEmpty<EntrySuccess, EntryLoading>, AdditionalEntry>,
	test1 extends Combine<FirstNotEmpty<EntrySuccess, EntryLoading>, AdditionalEntry>,
	DataFinal extends Combine<Data, AdditionalData>,
	Opts extends $EntryOpts<DataFinal, EntrySuccessFinal>
>(
	options?:
		| (Opts & {
...
) => $EntryStore<Args, EntryLoadingFinal, EntrySuccessFinal, DataFinal, Opts, test1>;
