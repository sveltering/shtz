...
type $EntryStore<
	...
	Data,
	Opts extends $EntryOpts<Data, EntryFinal>
> = Writable<$EntryInner<Args, EntryLoading, EntryFinal, Data, Opts>>;
...
type $EntryFn<Args extends any[], Data> = <
	...
	EntrySuccessFinal extends FirstNotEmpty<EntrySuccess, EntryLoading>,
	DataFinal extends Combine<Data, AdditionalData>,
...
) => $EntryStore<Args, EntryLoadingFinal, EntrySuccessFinal, DataFinal, Opts>;
