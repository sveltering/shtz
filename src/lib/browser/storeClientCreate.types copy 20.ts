...
type $EntryOpts<Data, EntryLoading extends {}, EntrySuccess extends {}> = {
	prefill?:
		| [EntrySuccess | EntryLoading, Data][]
		| (() => ToPromiseUnion<[EntrySuccess | EntryLoading, Data][]>);
	loading?: boolean;
	remove?: boolean;
	abort?: boolean;
	abortOnRemove?: boolean;
...
> =
	| SuccessResponse<
			[FirstNotEmpty<EntrySuccess, EntryLoading>, Data],
