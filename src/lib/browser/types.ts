...
type TransformerOpts = ArgumentTypes<
	typeof createTRPCProxyClient
>[0]["transformer"];
...
type ReplaceFunctionReturnOrUndefined<Fn> = Fn extends (
	...a: infer A
) => Promise<infer R>
...
export type BrowserOCC<T extends AnyRouter> = ChangeReturns<
 ...
 * LOAD CLIENT TYPES
 */
type LoadBatchLinkOptions = Omit<
	ArgumentTypes<typeof httpBatchLink>[0],
	"url" | "fetch"
>;
...
export type StoreCC<T extends AnyRouter> = MakeStoreType<
	CreateTRPCProxyClient<T>
>;
